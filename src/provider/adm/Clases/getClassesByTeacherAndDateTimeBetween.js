...
export async function getClassesByTeacherAndDateTimeBetween(idParticipant, year, month) {
    try {
        const url = `${process.env.REACT_APP_API_URL}/admin/clase/profesor?teacherID=${idParticipant}&year=${year}&month=${month}`;
        ...
        const classList = data.map((student) => ({//student =classItem
            id: student.id,
