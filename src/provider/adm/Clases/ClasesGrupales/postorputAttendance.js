...
export async function postORputAttendance(listOfstudents) {
    ...
    try {
        ...
        try {
            ...
            toast.error("Error al crear y actualizar la asistencia del equipo, por favor intentar mas tarde.");  
            console.error('Error posting and putting team class:', postError);
            throw postError;
        }
    }
}