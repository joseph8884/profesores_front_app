...
export async function delateStudentAPI(idUser) {
    const url = `${process.env.REACT_APP_API_URL}/admin/estudiante/personalizado/eliminar/${idUser}`; // URL de la API para crear un estudiante personalizado};
    ...
    try {
        ...
        if (!response.ok) {
            toast.error("Error al eliminar el Estudiante", responseText);    
